...
class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentViewHolder>{
    ...
    // Add a constructor that takes the calendar as a parameter
    public StudentAdapter(Context context, ArrayList<StudentItem> studentItems, MyCalendar calendar) {
    ...
    public static class StudentViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        // Context menu for editing student names
        @Override
    ...
    public void onBindViewHolder(@NonNull StudentViewHolder holder, int position) {
        ...
        holder.cardView.setCardBackgroundColor(getColor(position, studentItems.get(position).getStatus()));
    }

    private int getColor(int position, String status) {
        if(status.equals("P"))
